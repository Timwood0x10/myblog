...
```mermaid
flowchart TD
    subgraph WS[CreateWiredSystem]
        A[Population] --> E[WiredSystem]
        B[Genealogy] --> E
        C[StopChan] --> E
        D[Generation] --> E
        X["PromptTemplates"] -.->|"MISSING"| E
    end

    PP[PromptPool] -.->|"never connected"| X

    style X fill:#1e1e2e,stroke:#ff6e6e,stroke-dasharray:6 3
    style PP fill:#1e1e2e,stroke:#ff6e6e,stroke-dasharray:6 3
    style E fill:#1e1e2e,stroke:#e0af68
    style A fill:#1e1e2e,stroke:#56b6c2
    style B fill:#1e1e2e,stroke:#56b6c2
    style C fill:#1e1e2e,stroke:#56b6c2
    style D fill:#1e1e2e,stroke:#56b6c2
    style WS fill:#1a1a28,stroke:#6272a4,stroke-dasharray:4 3
```
...
```mermaid
flowchart LR
    TC[ToolCallRecord] --> RE[RawExperience]
    RE --> NE[NormalizedExperience]
    NE --> MS[MemoryExperienceStore]
    MS --> AE[AggregateEvidence]
    AE --> EH[EvolutionHint]

    style TC fill:#1e1e2e,stroke:#e0af68
    style RE fill:#1e1e2e,stroke:#e0af68
    style NE fill:#1e1e2e,stroke:#e0af68
    style MS fill:#1e1e2e,stroke:#bd93f9
